                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group">
                              <span id="basic-icon-default-fullname2">
                              <?php 
                                $listTeam = "SELECT * FROM team WHERE username='$_SESSION[username]'";
                                $queryTeam = mysqli_query($connect, $listTeam);
                                $resultTeam = mysqli_fetch_array($queryTeam);
                                ?>
                              <p><?php echo $resultTeam['team']; ?></p>
                              </span>
                            </div>
                          </div>
                        </div>
